...
- Transcript, summary, mind map, audio probe, normalized audio metadata, and storage artifacts are retained across soft delete and restore until a future Trash purge flow.
